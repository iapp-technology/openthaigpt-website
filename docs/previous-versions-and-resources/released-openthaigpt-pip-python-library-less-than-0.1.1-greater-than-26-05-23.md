...
description: 'ไลบรารี Python openthaigpt เวอร์ชัน 0.1.1 พร้อม Changelog วิธีติดตั้ง และตัวอย่างการเรียกใช้งานโมเดล OpenThaiGPT'
---
...
<a class="link-card" href="https://github.com/OpenThaiGPT/openthaigpt" target="_blank" rel="noopener noreferrer"><span class="link-card-title">OpenThaiGPT Pip Library — Source Code บน GitHub</span><span class="link-card-domain">github.com</span></a>
...
<a class="link-card" href="https://colab.research.google.com/drive/13yLIifBRDQp82QO4ICs_aEvz0N8tqVPm?usp=sharing" target="_blank" rel="noopener noreferrer"><span class="link-card-title">ตัวอย่างการเรียกใช้ Version 0.0.4 — เปิดใน Google Colab</span><span class="link-card-domain">colab.research.google.com</span></a>

<a class="link-card" href="https://github.com/OpenThaiGPT/openthaigpt-example" target="_blank" rel="noopener noreferrer"><span class="link-card-title">OpenThaiGPT/openthaigpt-example — ตัวอย่างโค้ดบน GitHub</span><span class="link-card-domain">github.com</span></a>

## Colab ตัวอย่างการเรียกใช้ (Version 0.1.0)

<a class="link-card" href="https://colab.research.google.com/drive/1Uds0ioOZSZrJ9m2FgW3DHlqVRFNHVRtu#scrollTo=qPJIpwuz4ltF" target="_blank" rel="noopener noreferrer"><span class="link-card-title">ตัวอย่างการเรียกใช้ Version 0.1.0 — เปิดใน Google Colab</span><span class="link-card-domain">colab.research.google.com</span></a>
