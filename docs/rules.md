...
1. ผลงานที่เกิดจากโครงการทั้งหมดต้องอยู่ภายใต้ลิขสิทธิ์ดังต่อไปนี้
   ...
   2. Dataset = CC BY-SA 
2. การเข้าถึงทรัพยากร (Open Resource) เป็นไปตามข้อมูลหน้า [open-resources](previous-versions-and-resources/open-resources/index.md "mention")โดยจะมีทรัพยากรบางส่วนที่เข้าถึงได้เฉพาะกลุ่มอาสาสมัครเท่านั้น ซึ่งกระบวนการมีดังต่อไปนี้
