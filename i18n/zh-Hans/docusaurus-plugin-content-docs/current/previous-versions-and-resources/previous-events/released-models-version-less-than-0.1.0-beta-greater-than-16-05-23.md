---
title: '已发布模型版本 <0.1.0-beta>（16/05/23）'
slug: '/previous-versions-and-resources/previous-events/released-models-version-less-than-0.1.0-beta-greater-than-16-05-23'
description: 'OpenThaiGPT 0.1.0-beta（2023 年 5 月 16 日）发布说明：基于泰语指令微调的 7B LLaMA 模型，并附早期 alpha 与 PoC 版本的更新日志。'
---
# 🔥 已发布模型版本 <0.1.0-beta>（16/05/23）

## 版本 0.1.0-beta（2023 年 5 月 16 日）
...
<a class="link-card" href="https://colab.research.google.com/drive/1nZ6Vc2U6rOezsMxarGJY7oDw8RG5E4r_?usp=sharing#scrollTo=lsOjziA3Dppt" target="_blank" rel="noopener noreferrer"><span class="link-card-title">体验 OpenThaiGPT 0.1.0-beta — Google Colab</span><span class="link-card-domain">colab.research.google.com</span></a>
