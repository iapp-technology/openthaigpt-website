...
description: 'The openthaigpt Python library version 0.1.1, with changelog, installation instructions, and examples of calling the OpenThaiGPT models.'
---
# 📦 Released OpenThaiGPT Pip Python Library <0.1.1> (26/05/23)

Want to use OpenThaiGPT? Anyone can get started easily as follows.
...
<a class="link-card" href="https://github.com/OpenThaiGPT/openthaigpt" target="_blank" rel="noopener noreferrer"><span class="link-card-title">OpenThaiGPT Pip Library — Source Code on GitHub</span><span class="link-card-domain">github.com</span></a>
...
Python >=3.6 is supported. Choose one of the following installation options.
...
## Example Project (Version 0.0.4)

<a class="link-card" href="https://colab.research.google.com/drive/13yLIifBRDQp82QO4ICs_aEvz0N8tqVPm?usp=sharing" target="_blank" rel="noopener noreferrer"><span class="link-card-title">Version 0.0.4 Usage Example — Open in Google Colab</span><span class="link-card-domain">colab.research.google.com</span></a>

<a class="link-card" href="https://github.com/OpenThaiGPT/openthaigpt-example" target="_blank" rel="noopener noreferrer"><span class="link-card-title">OpenThaiGPT/openthaigpt-example — Sample Code on GitHub</span><span class="link-card-domain">github.com</span></a>

## Example Colab (Version 0.1.0)

<a class="link-card" href="https://colab.research.google.com/drive/1Uds0ioOZSZrJ9m2FgW3DHlqVRFNHVRtu#scrollTo=qPJIpwuz4ltF" target="_blank" rel="noopener noreferrer"><span class="link-card-title">Version 0.1.0 Usage Example — Open in Google Colab</span><span class="link-card-domain">colab.research.google.com</span></a>
