...
<a class="link-card" href="https://demo.openthaigpt.aieat.or.th" target="_blank" rel="noopener noreferrer"><span class="link-card-title">Try the OpenThaiGPT Web Demo</span><span class="link-card-domain">demo.openthaigpt.aieat.or.th</span></a>

## Colab Demo

<a class="link-card" href="https://colab.research.google.com/drive/1kDQidCtY9lDpk49i7P3JjLAcJM04lawu?usp=sharing" target="_blank" rel="noopener noreferrer"><span class="link-card-title">Try OpenThaiGPT 1.0.0-alpha — Google Colab</span><span class="link-card-domain">colab.research.google.com</span></a>
