...
description: 'OpenThaiGPT 13b 1.0.0-beta, a Thai 13b-parameter LLaMA v2 Chat model pretrained on 15 billion Thai tokens, released 20 December 2023.'
---
...
* **Colab demo**: [Open in Google Colab](https://colab.research.google.com/drive/1dKNjLhOl1alBezcPdLihwqEOwJhcNAum?usp=sharing)
...
* **Weight (16 bits, Huggingface format)**: [openthaigpt-1.0.0-beta-13b-chat-hf — Hugging Face](https://huggingface.co/openthaigpt/openthaigpt-1.0.0-beta-13b-chat-hf)
* **Weight (16 bits and 4 bits, GGUF format)**: [openthaigpt-1.0.0-beta-13b-chat-gguf — Hugging Face](https://huggingface.co/openthaigpt/openthaigpt-1.0.0-beta-13b-chat-gguf)
